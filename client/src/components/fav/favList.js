                      ...
                      <Grid container spacing={2}>
                        <Grid container item lg={12} spacing={2} >
                          <Grid item sm={8} md={7} lg={9} >
                            {/* Channel Name */}
                            <h3 style={{ textDecoration: "bold", marginLeft: "-13px", paddingLeft: "0" }}>{fav.youtuber}</h3>
                          </Grid>

                          <Grid item sm={4} md={5} lg={3}>
                            <DeleteBtn onClick={() => destroyUserData(fav._id)} style={{ marginTop: "0", position: "absolute", right: "1vw", fontSize: "25px", fontWeight: "bold" }} />
                          </Grid>
                        </Grid>

                        <Grid container item xs={12} spacing={3} style={{ paddingTop: "5px" }}>
                          {/* Video Date */}
                          <p style={{ textDecoration: "italics", marginTop: "5px" }}>{dayjs(fav.vidDate).format("MMMM DD, YYYY")}</p>
                        </Grid>
                        <Grid container item xs={12} spacing={3} className={classes.detailItems}>
                          {/* Video Title */}
                          <h4>{fav.title}</h4>
                        </Grid>
                        <Grid container item xs={12} spacing={3} className={classes.detailItems}>
                          ...
                          <p>
                            {fav.details}
                            <a id="gradientAnchors" href={`https://www.youtube.com/watch?v=${fav.faveVids[0]}`} style={{ marginLeft: "6px" }} target="blank">See more on Youtube</a>
                          </p>
                        </Grid>
                      </Grid>
                    </div>
